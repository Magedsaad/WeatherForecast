package com.example.weatherforecast.features.home.data
...
import com.example.weatherforecast.features.home.data.remote.WeatherApiService
...
import com.example.weatherforecast.utils.result.NetworkBoundResource
import com.example.weatherforecast.utils.result.FetchLimiter
...
class CitiesRepositoryImpl @Inject constructor(
  ...
  override suspend fun populateCities() {
    ...
    Log.e("cities", "populateCities: sss")
